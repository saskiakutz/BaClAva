...
# clean up
rm(list = ls()) # deletes all workspace content
while (dev.cur() != 1) {
  dev.off()
}   # closes all graphs
...
foldernames = c(
  "~/Documents/bayesian/fluosim_data/fluosim_density_variation_noise_corr/50sbinding_noise_ungrouped",
  "~/Documents/bayesian/fluosim_data/fluosim_density_variation_noise_corr/50sbinding_noise_grouped",
  "~/Documents/bayesian/fluosim_data/fluosim_density_variation_noise_corr/40sbinding_noise_ungrouped",
  "~/Documents/bayesian/fluosim_data/fluosim_density_variation_noise_corr/40sbinding_noise_grouped",
  "~/Documents/bayesian/fluosim_data/fluosim_density_variation_noise_corr/20sbinding_noise_ungrouped",
  "~/Documents/bayesian/fluosim_data/fluosim_density_variation_noise_corr/20sbinding_noise_grouped",
  "~/Documents/bayesian/fluosim_data/fluosim_density_variation_noise_corr/15sbinding_noise_ungrouped",
  "~/Documents/bayesian/fluosim_data/fluosim_density_variation_noise_corr/15sbinding_noise_grouped"
)
...
l_ply(foldernames, function(expname) {
  ...
  nexpname = expname
  r = readLines(con = file.path(paste0(nexpname, "/config.txt", sep = "")))
